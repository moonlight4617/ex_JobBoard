...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('企業登録') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('shop.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('企業名(店舗名)') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="city" class="col-md-4 col-form-label text-md-right">{{ __('市町村') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="address" class="col-md-4 col-form-label text-md-right">{{ __('以下住所') }}</label>
